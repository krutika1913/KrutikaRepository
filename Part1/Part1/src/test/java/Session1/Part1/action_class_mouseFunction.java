...
public class action_class_mouseFunction extends Dynamic_code{
	...
	public static void main(String[] args) throws Throwable {
		...
		WebElement Draggable = driver.findElement(By.xpath("//a[text()=\"Draggable\"]"));    //locate draggable web element here first
		
		
		Actions act = new Actions(driver);     //then we create object for action class
